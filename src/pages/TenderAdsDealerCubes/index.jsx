...
import AdStatusList from "../../components/AdStatusList";
...
import TenderAdsDealerCubesColumnlink from "../../components/TenderAdsDealerCubesColumnlink";
...
export default function TenderAdsDealerCubesPage() {
  return (
    <>
      <Helmet>
            ...
            <div className="w-full overflow-x-scroll">
              <div className="flex w-[1880px] items-start gap-10 md:flex-col">
                ...
                <div className="flex flex-1 items-start md:flex-col md:self-stretch">
                  <div className="flex flex-1 items-start md:flex-col md:self-stretch">
                    <Tabs
                      className="relative h-[1158px] flex-1 self-center md:w-full md:flex-none md:self-stretch"
                    ...
                    >
                      <div className="absolute left-0 right-0 top-0 mx-auto flex-1">
                        <div className="relative z-[3] mr-11 md:mr-0">
                                ...
                                <Suspense fallback={<div>Loading feed...</div>}>
                                  {[...Array(8)].map((d, index) => (
                                    <a href="https://www.youtube.com/embed/bv8Fxk0sz7I" target="_blank">
                                      <TenderAdsDealerCubesColumnlink key={"Data2" + index} />
                                    </a>
                                  ))}
                                </Suspense>
                              </div>
                    ...
                    <div className="relative z-[5] ml-[-82px] flex w-[12%] items-start justify-center md:ml-0 md:w-full">
                      <div className="flex flex-1 items-start">
                        <div className="relative z-[6] mt-10 flex flex-1 flex-col items-end gap-[30px]">
                      ...
                      <div className="relative z-[7] ml-[-88px] mt-[18px] flex w-[30%] justify-center">
                        <a href="https://www.youtube.com/embed/bv8Fxk0sz7I" target="_blank">
                  ...
                  <Img
                    ...
                    alt="Tablistthree"
                    className="relative z-[8] ml-[-88px] mt-[490px] h-[40px] w-[6%] object-contain md:ml-0 md:w-full"
                  />
                </div>
              </div>
            </div>
