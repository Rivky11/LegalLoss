...
import ArchiveAdsProviderCubesColumncarx from "../../components/ArchiveAdsProviderCubesColumncarx";
import ArchiveAdsProviderCubesTwo from "../../components/ArchiveAdsProviderCubesTwo";
...
export default function ArchiveAdsProviderCubesPage() {
  return (
    <>
      <Helmet>
            ...
            <div className="w-full overflow-x-scroll">
              <div className="flex w-[1880px] items-start gap-10 md:flex-col">
                ...
                <div className="flex flex-1 items-start md:flex-col md:self-stretch">
                  <div className="flex flex-1 items-start md:flex-col md:self-stretch">
                    <Tabs
                      className="relative h-[1150px] flex-1 self-center lg:h-auto md:h-auto md:w-full md:flex-none md:self-stretch"
                    ...
                    >
                      <div className="flex flex-1 flex-col items-start">
                        <div className="relative z-[1] flex w-[14%] justify-center gap-1 rounded-br-lg bg-gray-100 lg:w-full md:w-full">
                        ...
                        <div className="relative mt-[-26px] h-[1052px] self-stretch rounded-[20px] bg-secondary-primary_white shadow-xs" />
                      </div>
                      <div className="absolute left-0 right-0 top-[3%] mx-[60px] flex flex-1 items-start justify-end gap-[22px] py-1.5 lg:mx-0 md:mx-0 sm:relative sm:flex-col">
                        <Heading size="h3_assistant_25px_m" as="h4" className="text-[25px] font-medium lg:text-[21px]">
                          מודעות רכבים שלי
                        </Heading>
                        <Img
                          src="images/img_car_red_a700_03_3.png"
                          alt="Caroneone"
                          className="mb-1.5 h-[36px] object-cover sm:mb-0 sm:w-full"
                        />
                      </div>
                      <div className="absolute left-0 right-0 top-[3%] mx-auto flex-1 px-6 sm:px-4">
                        <div>
                          ...
                          <div className="relative mr-6 mt-[-28px] flex justify-center border-b border-solid border-gray-200 px-14 md:mr-0 md:px-5 sm:px-4">
                            <ArchiveAdsProviderCubesTwo />
                          </div>
                        </div>
                      </div>
                      {[...Array(7)].map((_, index) => (
                                ...
                                <Suspense fallback={<div>Loading feed...</div>}>
                                  {[...Array(8)].map((d, index) => (
                                    <a href="https://www.youtube.com/embed/bv8Fxk0sz7I" target="_blank">
                                      <ArchiveAdsProviderCubesColumncarx key={"gridcar10660X44" + index} />
                                    </a>
                                  ))}
                                </Suspense>
                              </div>
