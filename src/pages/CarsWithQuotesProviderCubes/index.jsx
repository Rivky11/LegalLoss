...
import CarsWithQuotesProviderCubesColumncarx from "../../components/CarsWithQuotesProviderCubesColumncarx";
...
const data1 = [
  {
    ...
    prop4: "לצפיה בהצעות",
    prop5: "שיקום",
    two1: "images/img_vector_red_a700_03_22x34.svg",
  },
  {
    prop: "ממתין לאישור",
    prop1: "₪",
    ...
    prop4: "לצפיה בהצעות",
    prop5: "פירוק",
    two1: "images/img_television_red_a700_03_1.svg",
  },
  {
    prop: "ממתין לאישור",
    prop1: "₪",
...
export default function CarsWithQuotesProviderCubesPage() {
  return (
    <>
      <Helmet>
              ...
              <div className="flex h-full w-[1880px] items-start gap-10 md:flex-col">
                ...
                <div className="flex h-full flex-1 items-start md:flex-col md:self-stretch">
                  <div className="flex h-full flex-1 items-center md:flex-col md:self-stretch">
                            ...
                            <Suspense fallback={<div>Loading feed...</div>}>
                              {data1.map((d, index) => (
                                <a href="https://www.youtube.com/embed/bv8Fxk0sz7I" target="_blank">
                                  <CarsWithQuotesProviderCubesColumncarx {...d} key={"Data2" + index} />
                                </a>
                              ))}
                            </Suspense>
                          </div>
                    ...
                    <div className="relative z-[4] mb-8 ml-[-82px] flex w-[12%] flex-col gap-1.5 self-end md:ml-0 md:w-full">
                      <div>
