...
import { Img, Text, Switch, Heading, Button } from "../../components";
...
export default function ApprovedOffersDealerLinesPage() {
  return (
    <>
      <Helmet>
          ...
          <div className="container-12xl absolute bottom-0 left-0 right-0 top-0 my-auto h-max lg:px-5 md:px-5">
            <div className="overflow-x-scroll">
              <div className="flex w-[1880px] items-start gap-10">
                <Sidebar2 />
                <Tabs
                  className="relative h-[1108px] flex-1 self-center"
                  selectedTabClassName="!text-black-900_03"
                  selectedTabPanelClassName="mt-[172px] !relative tab-panel--selected"
                >
                  <div className="absolute left-0 top-0 my-auto ml-auto mr-[170px] flex flex-1 flex-col gap-[30px] rounded-[20px] bg-secondary-primary_white shadow-xs lg:mr-0 md:mr-0">
                    <header className="mr-[60px] flex flex-col items-start gap-3 md:mr-0">
                      ...
                      <div className="ml-[38px] flex items-start justify-between gap-5 self-stretch md:ml-0 md:flex-col">
                        ...
                        <div className="flex w-[74%] items-start justify-between gap-5 self-center md:w-full md:flex-col">
                          <TabList className="flex flex-wrap items-start gap-[52px] self-center px-2.5 py-1 lg:gap-5 md:gap-5">
                            <a href="https://www.youtube.com/embed/bv8Fxk0sz7I" target="_blank">
                              <Tab className="mb-2 ml-2.5 text-[16px] font-semibold text-gray-500_02 lg:text-[13px]">
                                הצעות שנדחו
                              </Tab>
                            </a>
                  ...
                  <div className="absolute bottom-[-1px] left-0 right-0 mx-auto flex flex-1 items-start md:relative md:flex-col">
                    {[...Array(4)].map((_, index) => (
                      <TabPanel key={`tab-panel${index}`} className="absolute z-[4] mt-[172px] flex-1 md:self-stretch">
                        <div className="relative z-[4] w-full flex-1 md:self-stretch">
                          <div className="ml-[42px] flex flex-col gap-[18px] md:ml-0">
                            <ComplexUIComponent />
                            <ComplexUIComponent />
                          </div>
                        </div>
          ...
          <div className="absolute bottom-[7px] left-0 right-0 z-[5] mx-auto flex w-[70%] border-t border-solid border-gray-400_11">
            <div className="mt-2 flex w-full flex-col gap-2.5">
              <div className="flex items-center bg-gray-100_02 p-2 md:flex-col">
                <div className="flex w-[46%] gap-[15px] md:w-full">
                  <Button
                    shape="round"
                    rightIcon={
                      <Img
                        ...
                        alt="Car"
                        className="mt-1 h-[14px] w-[18px] object-contain"
                      />
                    }
                    className="min-w-[138px] gap-1 rounded-[14px] pl-3.5 pr-2 font-dmsans font-medium capitalize"
                  >
                    חבילה שאושרה
                  </Button>
                  <div className="flex w-[18%] items-center justify-center gap-[18px] rounded-[14px] bg-secondary-primary_white">
                    <Heading
                      size="textmd"
                      as="h2"
                    ...
                    <Img src="images/img_television_red_a700_03_1.svg" alt="Televisionfive" className="h-[22px]" />
                  </div>
                </div>
                    ...
                    <div className="ml-3 flex flex-1 items-center justify-between gap-5 px-[18px] md:ml-0 md:self-stretch">
                      ...
                      <div className="flex w-[38%]">
                        <div className="w-[14%] bg-black-900">
                          <Img src="images/img_star_1_168.svg" alt="Imagefortyone" className="h-[8px] w-full" />
                        </div>
                        <div className="w-[14%] bg-black-900">
                          <Img src="images/img_star_1_169.svg" alt="Imagefortyone" className="h-[8px] w-full" />
                        </div>
                        <div className="w-[14%] bg-black-900">
                          <Img src="images/img_star_1_170.svg" alt="Imagefortytwo" className="h-[8px] w-full" />
                        </div>
                        <div className="w-[14%] bg-black-900">
                          <Img src="images/img_star_1_171.svg" alt="Image" className="h-[8px] w-full" />
                        </div>
                        <div className="w-[14%] bg-black-900">
                          <Img src="images/img_star_1_172.svg" alt="Imagefortyfour" className="h-[8px] w-full" />
                        </div>
                      </div>
                    </div>
                  </div>
