...
import NewAddsDealerLinesRowSix from "../../components/NewAddsDealerLinesRowSix";
...
export default function NewAddsDealerLinesPage() {
  return (
    <>
      <Helmet>
              ...
              <div className="flex w-[1880px] items-start gap-10 md:flex-col">
                ...
                <div className="relative h-[1110px] flex-1 self-center md:w-full md:flex-none md:self-stretch">
                  <div className="absolute left-0 top-0 my-auto ml-auto mr-[170px] flex-1 rounded-[20px] bg-secondary-primary_white shadow-xs lg:mr-0 md:mr-0">
                    ...
                    <AllAddsDealerLinesRownineteen className="ml-9 mr-[68px] mt-[18px] md:mx-0" />
                    <div className="mb-1 mt-3">
                      <div className="flex flex-col gap-1.5 px-[42px] md:px-5 sm:px-4">
                        <div className="mt-2.5 flex flex-col gap-1.5">
                          <Suspense fallback={<div>Loading feed...</div>}>
                            {data1.map((d, index) => (
                              <NewAddsDealerLinesRowSix {...d} key={"list" + index} />
                            ))}
                          </Suspense>
                        </div>
                        <div className="flex flex-col items-end">
                          <div className="h-[12px] self-stretch border-b border-solid border-gray-200" />
                          <div className="mx-1 flex items-start justify-end self-stretch md:mx-0 md:flex-col">
                            <div className="flex w-[8%] justify-end md:w-full">
                              <div className="flex w-full items-start">
                                <Img
                                  src="images/img_vector_1x14_3.png"
                                  alt="Vectorthreeone"
                                  className="mt-1.5 h-px object-cover"
                                />
                                <Heading size="headingxl" as="h1" className="self-center text-[15px] font-semibold">
                                  הגש הצעה
                                </Heading>
                              </div>
                            </div>
                            ...
                            <div className="flex flex-1 justify-center md:flex-col md:self-stretch">
                              <Heading
                                size="textmd"
                                as="h3"
                                className="flex items-center justify-center border border-solid border-black-900_03 bg-secondary-primary_white pl-3.5 pr-2 !font-dmsans text-[14px] font-medium capitalize"
                              >
                                ממתין להצעה
                              </Heading>
                              <div className="ml-10 flex gap-4 bg-secondary-primary_white px-1.5 md:ml-0">
                                <Heading
                                  size="textmd"
                                  as="h4"
                                ...
                                <Img
                                  src="images/img_vector_red_a700_03_1x34.png"
                                  alt="Vectorsevenone"
                              ...
                              <div className="flex flex-1 justify-end md:self-stretch">
                                <Img
                                  src="images/img_group_1261154309_secondary__primary_white_1x18_2.png"
                                  alt="Imagethirteen"
                                  className="h-px object-cover"
                                />
                                <Heading
                                ...
                                <Img
                                  src="images/img_group_1261154308_secondary__primary_white_1x18_2.png"
                                  alt="Imagefourteen"
                                  className="h-px object-cover"
                                />
                              </div>
                            ...
                            <Img
                              src="images/img_icon_1x14_2.png"
                              alt="Icononeone"
                              className="ml-1 mt-1.5 h-px object-cover md:ml-0 md:w-full"
                            />
                          </div>
                          <Img
                            src="images/img_icon_red_a700_03.png"
                            alt="Iconthreeone"
                            className="relative z-[4] mb-[18px] mt-[-26px] h-px object-cover"
                          />
                        </div>
                      </div>
                    </div>
                  </div>
                  <div className="absolute bottom-0 left-0 right-0 z-[5] mx-auto flex flex-1 items-start md:relative md:flex-col">
                    <div className="relative z-[6] flex-1 self-center md:self-stretch">
                      ...
                      <div className="flex items-start md:flex-col">
                        <div className="relative z-[7] mt-10 flex flex-1 flex-col items-end gap-[30px] py-1.5 md:self-stretch">
