...
export default function AwaitingApprovalDealerLinesPage() {
                    ...
                    <div className="flex flex-1 items-center justify-between gap-5 px-[38px] md:self-stretch sm:px-4">
                      ...
                      <div className="flex w-[30%] justify-center">
                        <div className="w-full bg-black-900">
                          <Img src="images/img_star_1_153.svg" alt="Imagefortyone" className="h-[8px] w-full" />
                        </div>
                        <div className="w-full bg-black-900">
                          <Img src="images/img_star_1_154.svg" alt="Imagefortyone" className="h-[8px] w-full" />
                        </div>
                        <div className="w-full bg-black-900">
                          <Img src="images/img_star_1_155.svg" alt="Imagefortytwo" className="h-[8px] w-full" />
                        </div>
                        <div className="w-full bg-black-900">
                          <Img src="images/img_star_1_156.svg" alt="Image" className="h-[8px] w-full" />
                        </div>
                        <div className="w-full bg-black-900">
                          <Img src="images/img_star_1_157.svg" alt="Imagefortyfour" className="h-[8px] w-full" />
                        </div>
                      </div>
                    </div>
                  </div>
