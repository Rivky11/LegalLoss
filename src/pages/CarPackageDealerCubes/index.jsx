...
import CarPackageDealerCubesRowten from "../../components/CarPackageDealerCubesRowten";
...
export default function CarPackageDealerCubesPage() {
  return (
    <>
      <Helmet>
              ...
              <div className="flex w-[1880px] items-start gap-10 md:flex-col">
                ...
                <div className="flex flex-1 items-start md:flex-col md:self-stretch">
                  <div className="flex flex-1 items-start md:flex-col md:self-stretch">
                          ...
                          <div className="absolute bottom-0 left-0 right-0 w-full flex-1">
                            <div className="flex flex-col gap-[22px]">
                              ...
                              <div className="grid grid-cols-4 justify-center gap-7 lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1">
                                <Suspense fallback={<div>Loading feed...</div>}>
                                  {[...Array(8)].map((d, index) => (
                                    <CarPackageDealerCubesRowten key={"Data2" + index} />
                                  ))}
                                </Suspense>
                              </div>
                            </div>
                    ...
                    <div className="relative z-[121] ml-[-82px] flex w-[12%] items-start justify-center md:ml-0 md:w-full">
                      <div className="flex flex-1 items-start">
                        <div className="relative z-[122] mt-10 flex flex-1 flex-col items-end gap-[30px]">
                      ...
                      <div className="relative z-[123] ml-[-88px] mt-[18px] flex w-[30%] justify-center">
                        <a href="https://www.youtube.com/embed/bv8Fxk0sz7I" target="_blank">
                  ...
                  <Img
                    ...
                    alt="Tablistthree"
                    className="relative z-[124] ml-[-88px] mt-[490px] h-[40px] w-[6%] object-contain md:ml-0 md:w-full"
                  />
                </div>
              </div>
            </div>
