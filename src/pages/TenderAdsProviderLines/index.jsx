...
export default function TenderAdsProviderLinesPage() {
  const table7Columns = React.useMemo(() => {
    const table7ColumnHelper = createColumnHelper();
    return [
      table7ColumnHelper.accessor("rowrow", {
        cell: (info) => (
      ...
      table7ColumnHelper.accessor("rowplumbingrepa", {
        cell: (info) => (
      ...
      table7ColumnHelper.accessor("rowplumbingrepa1", {
        cell: (info) => (
      ...
      table7ColumnHelper.accessor("rowplumbingrepa2", {
        cell: (info) => (
      ...
      table7ColumnHelper.accessor("rowplumbingrepa3", {
        cell: (info) => (
      ...
      table7ColumnHelper.accessor("rowplumbingrepa4", {
        cell: (info) => (
          <Heading as="h6" className="pl-[22px] text-[18px] font-semibold lg:text-[15px] sm:pl-4">
            {info.getValue()}
          </Heading>
      ...
      table7ColumnHelper.accessor("rowplumbingrepa5", {
        cell: (info) => (
      ...
      table7ColumnHelper.accessor("rowplumbingrepa6", {
        cell: (info) => (
          <Heading as="h6" className="pl-[22px] text-[18px] font-semibold lg:text-[15px] sm:pl-4">
            {info.getValue()}
          </Heading>
      ...
      table7ColumnHelper.accessor("rowplumbingrepa7", {
        cell: (info) => (
      ...
      table7ColumnHelper.accessor("rowplumbingrepa8", {
        cell: (info) => (
                ...
                <div className="relative h-[1110px] flex-1 self-center md:w-full md:flex-none md:self-stretch">
                  <div className="absolute left-0 top-0 my-auto ml-auto mr-[170px] flex-1 rounded-[20px] bg-secondary-primary_white shadow-xs lg:mr-0 md:mr-0">
                    <div className="mb-[18px] flex flex-col items-center">
                      ...
                      <div className="relative ml-6 mr-12 mt-2 h-[56px] self-stretch md:mx-0">
                        ...
                        <header className="absolute left-0 right-0 top-[3.05px] mx-auto flex flex-1 flex-col items-start">
                          <a href="#">
                            <Button
                              size="md"
                              className="relative z-[2] ml-[50px] w-[32px] rounded-[10px] px-1.5 md:ml-0"
                            >
                          ...
                          <div className="relative mt-[-32px] flex flex-col items-start self-stretch">
                            ...
                            <div className="relative mt-[-28px] flex self-stretch border-b border-solid border-gray-200 pl-[140px] pr-14 lg:pl-8 md:px-5 sm:px-4">
                              <div className="flex w-[76%] lg:w-full md:w-full">
                                <div className="mt-1 flex w-full flex-col items-start gap-2.5 self-end">
                                  <div className="flex self-stretch md:flex-col">
                                    <a href="https://www.youtube.com/embed/bv8Fxk0sz7I" target="_blank">
                                      <Heading
                                        size="h4_assistant_16px_b"
                                        as="h6"
                                        className="self-end text-[16px] font-semibold !text-gray-600 lg:text-[13px]"
                                      >
                                        מודעות בארכיון
                                      </Heading>
                                    </a>
                                    <a href="https://www.youtube.com/embed/bv8Fxk0sz7I" target="_blank">
                                      <Heading
                                        size="h4_assistant_16px_b"
                                        as="h6"
                                        className="ml-7 text-[16px] font-semibold !text-gray-500_02 lg:text-[13px] md:ml-0"
                                      >
                                        מודעות מאושרות
                                      </Heading>
                                    </a>
                                    <a href="https://www.youtube.com/embed/bv8Fxk0sz7I" target="_blank">
                                      <Heading
                                        size="h4_assistant_16px_b"
                                        as="h6"
                                        className="ml-[30px] text-[16px] font-semibold !text-gray-500_02 lg:text-[13px] md:ml-0"
                                      >
                                        חבילת רכבים
                                      </Heading>
                                    </a>
                                    <Heading
                                      size="h4_assistant_16px_b"
                                      as="h6"
                                      className="ml-6 text-[16px] font-semibold lg:text-[13px] md:ml-0"
                                    >
                                      מודעות במכרז
                                    </Heading>
                                    <a href="https://www.youtube.com/embed/bv8Fxk0sz7I" target="_blank">
                                      <Heading
                                        size="h4_assistant_16px_b"
                                        as="h6"
                                        className="ml-[26px] text-[16px] font-semibold !text-gray-500_02 lg:text-[13px] md:ml-0"
                                      >
                                        מודעות עם הצעות מחיר
                                      </Heading>
                                    </a>
                                    <ul className="!ml-9 flex flex-wrap gap-8 md:ml-0">
                                      <li>
                                        <a href="https://www.youtube.com/embed/bv8Fxk0sz7I" target="_blank">
                                          <Heading
                                            size="h4_assistant_16px_b"
                                      ...
                                      <li>
                                        <a href="https://www.youtube.com/embed/bv8Fxk0sz7I" target="_blank">
                                          <Heading
                                            size="h4_assistant_16px_b"
                                            as="h6"
                                            className="text-[16px] font-semibold !text-gray-600 hover:!text-gray-500_02"
                                          >
                                            כל המודעות
                                          </Heading>
                                        </a>
                                  ...
                                  <div className="ml-[356px] h-[2px] w-[16%] bg-red-a700_03 md:ml-0" />
                                </div>
                              </div>
                            </div>
                          </div>
                      ...
                      <ReactTable
                        ...
                        className="ml-10 mr-8 self-stretch md:mx-0 md:block md:overflow-x-auto md:whitespace-nowrap"
                  ...
                  />
                  <div className="absolute bottom-[-1px] left-0 right-0 mx-10 flex-1 lg:mx-0 md:mx-0">
                    ...
                    <div className="flex items-start md:flex-col">
                      <div className="relative z-[3] mt-10 flex flex-1 flex-col items-end gap-[30px] md:self-stretch">
                        ...
                        <div className="mb-[86px] flex flex-col gap-1 self-stretch">
                          ...
                          <div className="flex justify-end px-3.5 py-4">
                            <Img src="images/img__1.svg" alt="Imagethirteen" className="h-[20px]" />
                          </div>
                          <div className="flex justify-end px-3.5 py-4">
                          ...
                          <div className="flex justify-end px-3.5 py-4">
                            <Img src="images/img__4.svg" alt="Imagethirtytwo" className="h-[20px]" />
                          </div>
                          ...
                          <div className="flex justify-end px-3.5 py-4">
                            <Img src="images/img__5.svg" alt="Imagefifteen" className="h-[20px]" />
                          </div>
                          <div className="flex justify-end px-3.5 py-4">
