...
export default function AllAddsProviderCubes1Page() {
          ...
          <div className="relative h-[1150px] w-[88%] self-center md:w-full">
                              ...
                              <div className="mt-2">
                                ...
                                <div className="mx-[30px] flex flex-col gap-0.5 md:mx-0">
                                  ...
                                  <div className="mx-[38px] flex items-center justify-center gap-2 md:mx-0">
                                    ...
                                    <div className="h-[16px] w-[16px] rounded border border-solid border-deep_purple-400" />
                                    <div className="flex flex-1 flex-col items-center justify-center rounded-lg bg-black-900_03 p-1">
                                      <Img
            ...
            <a href="https://www.youtube.com/embed/bv8Fxk0sz7I" target="_blank">
              <div className="absolute bottom-[-0.14px] right-[34%] m-auto w-[30%] rounded-[16px] bg-secondary-primary_white">
                ...
                <div className="flex flex-col items-center rounded-bl-[16px] rounded-br-[16px] border-b border-l border-r border-solid border-gray-200 p-3">
                  ...
                  <div className="mb-[68px] mt-5 flex w-[88%] items-center justify-center gap-2 lg:w-full md:w-full">
                    <div className="flex flex-1 justify-center px-7 sm:px-4">
