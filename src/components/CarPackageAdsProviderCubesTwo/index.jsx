...
export default function CarPackageAdsProviderCubesTwo({
  prop = "מודעות בארכיון",
  ...
  return (
    <div {...props} className={`${props.className} flex items-start gap-[30px] py-1 flex-wrap`}>
      <Text className="mb-2 text-[16px] font-semibold !text-gray-600">{prop}</Text>
      ...
      <Text className="text-[16px] font-semibold !text-gray-600">{prop5}</Text>
    </div>
  );
}
