...
export default function ArchiveAdsProviderCubesColumncarx({ ...props }) {
  ...
  return (
    <div {...props} className={`${props.className} flex flex-col w-full bg-secondary-primary_white rounded-[16px]`}>
            ...
            items={[...Array(3)].map(() => (
              <React.Fragment key={Math.random()}>
                <div className="relative h-[218px] content-center">
                  ...
                  <Button
                    shape="round"
                    className="absolute left-[21px] top-[22px] m-auto min-w-[104px] rounded-[14px] px-[34px] font-dmsans font-medium capitalize sm:px-5"
                  >
                    ארכיון
                  </Button>
                </div>
      ...
      <div className="self-stretch rounded-bl-[16px] rounded-br-[16px] border-b border-l border-r border-solid border-gray-200 py-1">
        ...
        <div className="relative ml-[30px] mr-[22px] mt-4 h-[56px]">
