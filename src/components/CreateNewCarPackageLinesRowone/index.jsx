...
export default function CreateNewCarPackageLinesRowone({
  prop = "לצפיה במודעה",
  prop1 = "ממתין לאישור",
  prop2 = "פירוק",
  prop3 = "₪",
  ...
  return (
    <div {...props} className={`${props.className} flex items-center self-stretch flex-1 container-4xl`}>
      <div className="flex w-full items-center justify-center gap-3 border-b border-solid border-gray-200 py-3 md:flex-col">
        <div className="flex flex-1 items-center justify-center gap-[26px] md:flex-col md:self-stretch">
          <div className="flex items-center gap-0.5">
            <Img src="images/img_settings_black_900.svg" alt="לצפיה במודעה" className="h-[14px]" />
          ...
          <div className="flex flex-1 items-center justify-center md:flex-col md:self-stretch">
            <div className="flex flex-1 items-center justify-center md:self-stretch sm:flex-col">
              ...
              <div className="ml-12 flex w-[16%] items-center justify-center gap-[18px] rounded-[14px] bg-secondary-primary_white sm:ml-0 sm:w-full">
                <Heading
                  size="textmd"
                  as="p"
              ...
              <div className="flex flex-1 flex-wrap justify-between gap-5 self-end px-[52px] md:px-5 sm:self-stretch">
                <Heading size="heading5xl" as="h6" className="text-[18px] font-semibold">
                  {plumbingrepair2}
                </Heading>
                <Heading size="heading5xl" as="h6" className="mr-2.5 text-[18px] font-semibold md:mr-0">
                  {plumbingrepair3}
                </Heading>
              </div>
            </div>
        ...
        <Img src="images/img_checkmark.svg" alt="לצפיה במודעה" className="h-[16px] md:w-full" />
      </div>
    </div>
  );
}
