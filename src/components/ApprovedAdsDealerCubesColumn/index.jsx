...
export default function ApprovedAdsDealerCubesColumn({ ...props }) {
    ...
    <div {...props} className={`${props.className} flex flex-col w-full bg-secondary-primary_white rounded-[16px]`}>
      <div className="self-stretch">
        <div className="relative h-[218px] content-center">
          ...
          <div className="absolute bottom-0 right-1.5 top-0 my-auto flex h-max w-[18%] justify-center rounded-[20px] bg-white-a700_33 p-3">
            <Img src="images/img_arrow_right.svg" alt="Arrowrightone" className="h-[12px]" />
          </div>
        </div>
        <div className="flex flex-col items-center rounded-bl-[16px] rounded-br-[16px] border-b border-l border-r border-solid border-gray-200 p-1">
          <div className="mx-3 mt-1.5 flex self-stretch pl-[78px] pr-14 md:px-5">
          ...
          <div className="ml-3 mt-5 flex flex-col gap-4 self-stretch">
            <div className="mr-3 flex items-center justify-between gap-5">
