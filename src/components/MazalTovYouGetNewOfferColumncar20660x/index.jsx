...
export default function MazalTovYouGetNewOfferColumncar20660x({
  prop = "₪",
  fortythousand = "40,000",
  prop1 = "המחיר הגבוהה להצעה:",
  x85zero = "X8 – 5.0 במוו",
  zipcode = "2022",
  prop2 = "במוו",
  p2287 = "2287 נפח מנוע",
  ...
  return (
    <div {...props} className={`${props.className} bg-secondary-primary_white rounded-[16px]`}>
      <div className="relative h-[218px] content-center self-stretch">
        ...
        />
        <div className="absolute bottom-[-0.11px] left-0 right-0 mx-auto flex flex-1 flex-col gap-[58px]">
          <div className="ml-1.5 mr-1 flex justify-between gap-5">
          ...
          <div className="bg-red-a700_cc px-14 md:px-5">
      ...
      <div className="self-stretch rounded-bl-[16px] rounded-br-[16px] border-b border-l border-r border-solid border-gray-200 py-1">
        ...
        <div className="ml-[30px] mr-[26px] mt-3 flex flex-col gap-4">
          ...
          <div className="relative h-[56px]">
            <div className="absolute bottom-0 left-0 right-0 top-0 m-auto flex h-max flex-1 items-end border-t border-solid border-gray-200 py-3">
              <Img src="images/img_settings_black_900.svg" alt="Settingsoneone" className="h-[14px]" />
              <Heading size="h4_assistant_16px_b" as="h6" className="mt-2 text-[16px] font-semibold">
                {prop4}
              </Heading>
            </div>
