...
export default function DashboredDealerRow({
  two = "לצפיה בהצעה",
  two1 = "לצפיה",
  prop = "ממתין לאישור",
  prop1 = "פירוק",
  ...
  return (
    <div
      {...props}
      className={`${props.className} flex items-center self-stretch px-1 py-3 border-gray-200 border-b border-solid flex-1 container-3xl`}
    >
